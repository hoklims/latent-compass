...
Vérification locale au dernier commit de code : Ruff, mypy, 1 337 tests réussis et 3 cas POSIX ignorés sous Windows ; build et wheel validés hors checkout. Les 917 tests de la base existent toujours. Vérifie la CI du SHA courant avant de t’en prévaloir.
