...
Vérification locale au commit `7a72403` (le dernier commit de code reste `bf3b73d` : `5684870`, `2b73490`, `c9fdccc` et `7a72403` n’ajoutent que des preuves, des tests et de la documentation) : Ruff, mypy, 1 359 tests réussis et 3 cas POSIX ignorés sous Windows, sur un poste où `pyright-langserver` est installé ; build et wheel validés hors checkout sur `bf3b73d`, banc exécuté avec les deux outils symboliques. Les 917 tests de la base existent toujours. Vérifie la CI du SHA courant avant de t’en prévaloir.
