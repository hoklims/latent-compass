...
Vérification locale au dernier commit de code (`bf3b73d`) : Ruff, mypy, 1 349 tests réussis et 3 cas POSIX ignorés sous Windows, sur un poste où `pyright-langserver` est installé ; build et wheel validés hors checkout, banc exécuté avec les deux outils symboliques. Les 917 tests de la base existent toujours. Vérifie la CI du SHA courant avant de t’en prévaloir.
