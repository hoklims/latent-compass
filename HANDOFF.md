...
Vérification locale au dernier commit de code (`7c59b2b`) : Ruff, mypy, 1 338 tests réussis et 3 cas POSIX ignorés sous Windows ; build et wheel validés hors checkout. Les 917 tests de la base existent toujours. Vérifie la CI du SHA courant avant de t’en prévaloir.
